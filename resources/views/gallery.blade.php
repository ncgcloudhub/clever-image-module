...
<section>
    <div class="flex items-start justify-between gap-3 mb-5 sm:mb-7">
        <div>
            <h2 class="text-2xl sm:text-3xl font-black leading-tight text-white">My Gallery</h2>
            <p class="text-slate-400 text-xs sm:text-sm leading-snug mt-1">All your AI-generated images</p>
        </div>
